...
> [!NOTE]
> This project is under active development and might not be fully functional. There's known issues with button detection, and sensitivity is in testing phases.
